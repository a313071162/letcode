...
- 剑指Offer67 这道题相对来说不难，就是其有一个最大值限制还有正负号判断，有点绕，多测试就好了
- 剑指Offer30 程序设计题，就是一个min函数的实现，这里我了解了别人的方法，速度更快。加了一个栈来存储最小值
- 剑指Offer46 需要有一个回溯的思想在里面，有一个创新解回来看就记不起了，记得当时也没理解的很透彻
